...
namespace CyberAsm
{
	...
	public:
		...
		[[nodiscard]] auto rbegin() const noexcept -> std::vector<char8_t>::const_reverse_iterator;
		[[nodiscard]] auto rend() const noexcept -> std::vector<char8_t>::const_reverse_iterator;
		auto rbegin() noexcept -> std::vector<char8_t>::reverse_iterator;
		auto rend() noexcept -> std::vector<char8_t>::reverse_iterator;
		...
		auto operator <<(char8_t value) -> MachineStream&;
		...
		auto operator <<(const char8_t* value) -> MachineStream&;
		...
		auto operator <<(std::span<char8_t> value) -> MachineStream&;
		auto operator <<(std::span<std::byte> value) -> MachineStream&;
		auto operator <<(const std::vector<char8_t>& value) -> MachineStream&;
		auto operator <<(const std::vector<std::byte>& value) -> MachineStream&;
		auto operator <<(std::initializer_list<char8_t>&& value) -> MachineStream&;
		...
		[[nodiscard]] auto Find(char8_t target) const -> std::vector<char8_t>::const_iterator;
		[[nodiscard]] auto Contains(std::span<char8_t> sequence) const -> bool;
